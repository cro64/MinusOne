...
final class PracticeSplitViewController: NSSplitViewController {
    ...
    init(sidebar: NSViewController, detail: NSViewController) {
        ...
        // the split view is actually placed — measured at 24pt of dead space under
        // `MainWindowController`'s 38pt `headerRow`, which sits above this split view.
        // `ClipSidebarViewController` paints its own background instead.
